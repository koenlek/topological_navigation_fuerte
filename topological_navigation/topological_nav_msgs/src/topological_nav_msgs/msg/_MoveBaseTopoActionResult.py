"""autogenerated by genpy from topological_nav_msgs/MoveBaseTopoActionResult.msg. Do not edit."""
import sys
...
class MoveBaseTopoActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "topological_nav_msgs/MoveBaseTopoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','topological_nav_msgs/MoveBaseTopoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveBaseTopoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = topological_nav_msgs.msg.MoveBaseTopoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = topological_nav_msgs.msg.MoveBaseTopoResult()
