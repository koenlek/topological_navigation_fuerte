"""autogenerated by genpy from topological_nav_msgs/MoveBaseTopoActionFeedback.msg. Do not edit."""
import sys
...
class MoveBaseTopoActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "topological_nav_msgs/MoveBaseTopoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','topological_nav_msgs/MoveBaseTopoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveBaseTopoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = topological_nav_msgs.msg.MoveBaseTopoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = topological_nav_msgs.msg.MoveBaseTopoFeedback()
